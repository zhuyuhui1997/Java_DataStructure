...
public class TwoQueueStack<T> {
    ...
    private TwoQueueStack(int size) {
    ...
    public void test() {
        ...
        twoQueueStack.push(7);
        twoQueueStack.push(1);
        assertEquals(twoQueueStack.size(), 3);
        assertFalse(twoQueueStack.isEmpty());
        assertEquals((long) twoQueueStack.peek(), 1);
        assertEquals((long) twoQueueStack.pop(), 1);
        assertEquals((long) twoQueueStack.pop(), 7);
        assertFalse(twoQueueStack.isEmpty());
        assertEquals((long) twoQueueStack.pop(), 4);
        twoQueueStack.push(11);
        twoQueueStack.push(12);
        assertEquals((long) twoQueueStack.pop(), 12);
        assertEquals((long) twoQueueStack.pop(), 11);
        assertEquals(true, twoQueueStack.isEmpty());
    }
